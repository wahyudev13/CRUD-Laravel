...
<head>
  ...
  <title>Formulir Data Kader IMM Gresik</title>
  <meta content="immgresik, immjawatimur" name="description">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="#" class="logo d-flex align-items-center w-auto">
                    <img  src="/file/setting/{{$dasboard[0]->logo}}" alt="">
                  <span class="d-none d-lg-block">Formulir Data Kader</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    @endif
                    <p class="text-center small">Mohon mengisi data diri dengan lengkap dan benar untuk menunjang pemetaan database kader IMM Gresik</p>
                  </div>

                  <form class="row g-3 needs-validation" action="/formulir/store" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <input type="date" name="masuk" class="form-control" id="masuk" required>
                      <div class="invalid-feedback">Please enter a valid Email adddress!</div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <label for="jabatan" class="form-label">Jabatan Sekarang</label>
                    ...
                    <div class="col-12">
                      <label for="foto" class="form-label">Upload Foto Formal 3x4</label>
